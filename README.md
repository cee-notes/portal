...
`bash tools/run.sh` runs all of it: **82 checks, all passing** (51 backend, 7 single-file,
24 real-DOM UI). The UI tests load the actual `index.html` in jsdom with `google.script.run`
